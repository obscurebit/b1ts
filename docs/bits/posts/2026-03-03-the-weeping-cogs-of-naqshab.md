---
date: 2026-03-03
title: "The Weeping Cogs of Naqshab"
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2rem;">
  <button class="share-btn" data-url="{% raw %}{{ page.canonical_url }}{% endraw %}" data-title="The Weeping Cogs of Naqshab">
    Share this story
  </button>
  <a href="https://github.com/obscurebit/b1ts/tree/c67c137" target="_blank" rel="noopener" class="story-gen-link">
    gen:c67c137
  </a>
</div>
